...
class ImageViewPageState extends State<ImageViewPage> {
  ...
  Widget build(BuildContext context) {
    var imgs = <Image>[
      Image.asset("res/images/avatar.png", width: 150.0),
      Image.network("http://q8xcfpnt5.bkt.clouddn.com/timg.jpg", width: 150.0),
      Image(image: AssetImage("res/images/avatar.png"), width: 100.0, color: Colors.blue, colorBlendMode: BlendMode.difference),
      Image(image: AssetImage("res/images/avatar.png"), width: 100.0, height: 300.0, repeat: ImageRepeat.repeatY)
    ];
